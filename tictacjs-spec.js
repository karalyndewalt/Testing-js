...
describe("Tic Tac JS", function () {
    ...
    it("should make computer moves", function () {
       ...
       // expect(newBoardPiece).toBe($("#cell-1").text());
    ...
    it("should not fill in board slots that are already occupied", function() {
        board = ["X", "O", "X", "O", null, null, null, null];

        var slotOpen1 = placePiece(5, "X");
        var slotOpen2 = placePiece(0, "O");
        expect(slotOpen1).toBeTruthy();
        expect(slotOpen2).toBeFalsy();
    });
